    ...
    return (
        <div className="max-w-6xl mx-auto space-y-6 md:space-y-8 animate-in slide-in-from-right duration-300 pb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                <SensorCard title="Umidade Solo" icon={Droplets} data={soilData} unit="%" color="green" measurementId={soilMeasurementId} />
                <SensorCard title="Qualidade Ar" icon={Wind} data={airData} unit=" AQI" color="blue" measurementId={airMeasurementId} />
                <SensorCard title="Temperatura" icon={Thermometer} data={tempData} unit="°C" color="orange" measurementId={tempMeasurementId} />
                <SensorCard title="Luminosidade" icon={Sun} data={lightData} unit=" lx" color="yellow" measurementId={lightMeasurementId} />
                <SensorCard title="Mock" icon={Sun} data={mockData} unit=" lx" color="yellow" measurementId={mockMeasurementId} />
            </div>
