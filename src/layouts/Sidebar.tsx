  ...
  return (
      <aside className="hidden md:flex w-20 lg:w-64 bg-white border-r border-stone-200 flex-col justify-between p-4 sticky top-0 h-screen z-10">
        ...
        <div className="border-t border-stone-100 pt-6">
          ...
          >
            <div className="w-10 h-10 rounded-full bg-emerald-100 overflow-hidden shrink-0 border-2 border-white shadow-sm flex items-center justify-center text-emerald-600 font-bold uppercase">
              {avatarLetter}
            </div>
            <div className="hidden lg:block overflow-hidden flex-1">
              {/* Enquanto /auth/me não retorna, mostra um placeholder suave */}
