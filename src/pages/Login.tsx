          ...
          <div className="w-full max-w-md space-y-6 md:space-y-8 bg-white md:bg-transparent p-6 md:p-0 rounded-3xl md:rounded-none shadow-xl md:shadow-none border border-stone-100 md:border-none">
            ...
            <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
              ...
              <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3 md:py-4 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-60 disabled:cursor-not-allowed text-white rounded-xl font-bold shadow-lg shadow-emerald-200 transition-all active:scale-95 flex items-center justify-center gap-2 mt-4 md:mt-6 text-sm md:text-base"
              >
                {loading ? (
